object DMCONS: TDMCONS
  ...
  object T_MoviIb: TTable
    ...
    object T_MoviIbFECHAGASBOY: TStringField
      FieldName = 'FECHAGASBOY'
      Size = 6
    end
    object T_MoviIbHORAGASBOY: TStringField
  ...
  object Q_MoviGasboy: TQuery
    DatabaseName = 'DBGASCONSOLA'
    SQL.Strings = (
      'select transaccion,hora,FechaGasboy,HoraGasboy from DPVGMOVI'
      'where folio= (select max(folio) from DPVGMOVI)')
    Left = 96
    Top = 184
    object Q_MoviGasboyTRANSACCION: TIntegerField
      FieldName = 'TRANSACCION'
    end
    object Q_MoviGasboyHORA: TDateTimeField
      FieldName = 'HORA'
    end
    object Q_MoviGasboyFECHAGASBOY: TStringField
      FieldName = 'FECHAGASBOY'
      Size = 6
    end
    object Q_MoviGasboyHORAGASBOY: TStringField
      FieldName = 'HORAGASBOY'
      Size = 4
    end
  end
  ...
  object Q_BombIb: TQuery
    ...
    SQL.Strings = (
      ...
      '          digitosgilbarco,decimalesgilbarco from dpvgbomb'
  ...
  object T_Cvolt: TTable
    DatabaseName = 'DBGASCONSOLA'
    IndexFieldNames = 'FECHA;CORTE;TANQUE'
  ...
  object Q_Movi: TQuery
    ...
    object Q_MoviFECHAGASBOY: TStringField
      FieldName = 'FECHAGASBOY'
      Origin = 'DBGASCONSOLA.DPVGMOVI.FECHAGASBOY'
      Size = 6
    end
    object Q_MoviHORAGASBOY: TStringField
      FieldName = 'HORAGASBOY'
