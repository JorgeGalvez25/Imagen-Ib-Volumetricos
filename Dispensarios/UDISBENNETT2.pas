...
procedure TFDISBENNETT2.DespliegaMemo4(lin:string);
begin
              ...
              if DMCONS.swemular then
                if xpos in [1..MaxPosCarga] then
                  if EmularEstatus[2*xpos]='5' then
                    EmularEstatus[2*xpos]:='6'  // Si el flujo ya inici�, para el despache momentaneamente y se puede reanudar.
                  else
...
begin
  try
    if not StaticText6.Visible then begin
      StaticText6.Caption:='Puerto: '+DMCONS.PuertoServicio;
