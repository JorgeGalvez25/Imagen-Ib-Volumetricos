...
type
  ...
  public
    ...
    procedure EnviaPreset3(var rsp:string;xcomb:integer;xflujo:Real=0);
                      ...
                      if rsp='OK' then begin
                        ...
                        if rsp='OK' then begin
                          if (TPosCarga[SnPosCarga].estatus in [1,5,7,9]) then begin
                            ...
                            flujo:=StrToFloatDef(ExtraeElemStrSep(TabCmnd[xcmnd].Comando,7,' '),0);;
                            if xp>0 then begin

                              TPosCarga[SnPosCarga].finventa:=StrToIntDef(ExtraeElemStrSep(TabCmnd[xcmnd].Comando,6,' '),0);
                              EnviaPreset3(rsp,xcomb,flujo);
                            end
...
procedure TFDISGATEWAY.EnviaPreset3(var rsp:string;xcomb:integer;xflujo:Real);
...
begin
  ...
  flujoStr:=StringReplace(FloatToStr(xflujo),'.','',[]);
  xprodauto:=copy(xprodauto,1,3)+flujoStr;
